          ...
          <div className="row">
            ...
            <article className="best-post">
              ...
              <div className="best-post-content">
                <div className="best-post-content-cat">November 2, 2022<span className="dot"> </span>Blog</div>
                <div className="best-post-content-title">
                 Quick Node, Solana, Phantom Blog Aplication
                </div>
                    ...
                    <div className="post__card_-2">
                      ...
                      <div>
                        <div className="post__card_meta-2">
                          <div className="post__card_cat">November 2, 2022<span className="dot"> </span>{item.account.title} </div>
